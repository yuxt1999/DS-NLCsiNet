...
compression_rate = 2 # positive integer, 1 causes no reduction
...
history = LossHistory()
file = 'NLCsiNet_'+(envir)+'_dim'+str(encoded_dim)+'_'+str(compression_rate)+'_'+(non_local_mode)+time.strftime('_%m_%d')
